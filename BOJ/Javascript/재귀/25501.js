...
둘쨰 줄부터 T개의 줄에 알파벳 대문자로 구성된 문자열 S가 주어진다. (1<=|S|<=1000)
 *
 * ex1) 
5
AAA
...
for (const s of input) {
  answer += isPalindrome(s).join(" ") + "\n";
}

const index = answer.lastIndexOf("\n");
console.log(answer.substring(0, index));

// indexOf : 앞에서부터 / lastIndexOf : 끝에서부터 => 발경하면 해당 요소의 인덱스 반환
...
// substring(n, m) : slice와 마찬가지로 n과 m사이 문자열 반환
